...
#include <algorithm>
/*Method to update routing table. This method increments and evaporates pheromone values as per AntHocNet algorithm.
 *dest destination node address
 *next neighbor node address*/
...
/*Method to create backward ant packet. This is called when forward ant reaches destination node*/
